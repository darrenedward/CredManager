...
<instructions>
  ...
  REQUIREMENT: Run TypeScript tests and npm run build to ensure no TypeScript errors and clean builds
</instructions>
...
<instructions>
  ...
  REQUIREMENT: Always use git for version control - add, commit, and use branches for feature development
</instructions>
