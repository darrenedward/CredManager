...
<analysis_areas>
  ...
  <implementation_progress>
    ...
    - Database schema and seeding status
    - Testing coverage and practices
    - Security implementations (rate limiting, input validation, etc.)
...
<instructions>
  ...
  DOCUMENT: Current technologies, features, security measures, and testing practices
  IDENTIFY: Architectural decisions already made
  NOTE: Development progress, security implementations, and testing coverage
  ASSESS: Security posture and testing maturity
</instructions>
...
<context_questions>
  ...
  3. **Security & Testing**: What security measures are in place? What's the current testing strategy and coverage?

  4. **Roadmap**: What features are planned next? Any major refactoring planned?
...
<verification_checklist>
  ...
  - [ ] Security measures are documented and assessed
  - [ ] Testing practices and coverage are evaluated
</verification_checklist>
...
<summary_template>
  ...
  - **Security Assessment**: [SECURITY_MEASURES_FOUND]
  - **Testing Coverage**: [TESTING_PRACTICES_EVALUATED]
  ...
  - ✓ Security and testing assessment documented
