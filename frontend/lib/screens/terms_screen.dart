          ...
          child: Column(
            ...
            children: [
              ...
              _buildSectionCard(
                ...
                Icons.code,
                [
                  _buildText('Cred Manager is open source software licensed under the MIT License:'),
                  _buildText('You are free to:'),
                  _buildBullet('Use the software for any purpose'),
                  _buildBullet('Modify the source code'),
                  _buildBullet('Distribute the software'),
                  _buildText('Subject to the following conditions:'),
                  _buildBullet('Include the original copyright notice'),
                  _buildBullet('The software is provided "as is" without warranty'),
                  _buildText('For full license text, visit: '),
                  _buildLink('https://opensource.org/licenses/MIT'),
                ],
              ),
